...
export default function LandingPage() {
  ...
  return (
    <main className="text-gray-800">
      <section className="px-6 py-24 max-w-6xl mx-auto bg-gradient-to-br from-blue-50 via-white to-green-50 rounded-xl shadow-md">
      ...
      >
        ...
        <div className="grid md:grid-cols-3 gap-8 text-left">
          ...
          <div className="bg-white shadow-lg rounded-xl p-6 border-t-4 border-yellow-400">
            <h3 className="text-xl font-semibold mb-2 text-blue-800">
              3. Watch It Grow
            </h3>
            <p className="text-gray-600">
      ...
      <section className="px-6 py-20 max-w-6xl mx-auto text-center">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-white rounded-xl shadow p-6 text-left">
            ...
            <p className="font-semibold text-blue-800">— Sarah, 25, Lagos</p>
          </div>
          <div className="bg-white rounded-xl shadow p-6 text-left">
            <p className="text-gray-600 mb-4 italic">
            ...
            <p className="font-semibold text-blue-800">— David, 32, Nairobi</p>
          </div>
          <div className="bg-white rounded-xl shadow p-6 text-left">
            <p className="text-gray-600 mb-4 italic">
            ...
            <p className="font-semibold text-blue-800">— Amina, 20, Accra</p>
          </div>
        </div>
      </section>
    </main>
