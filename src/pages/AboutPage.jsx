export default function AboutPage() {
  return (
    <main className="px-6 py-16 max-w-5xl mx-auto text-gray-800">
      <section className="text-center mb-12">
        <h2 className="text-4xl font-extrabold text-blue-900 mb-4">About CryptoInvest</h2>
        <p className="text-lg text-gray-600 max-w-3xl mx-auto">
          Making crypto investing simple, secure, and accessible for everyone starting at just $1.
        </p>
      </section>

      <section className="bg-red-50 p-6 md:p-10 rounded-xl shadow-inner border-l-4 border-red-400 mb-12">
        <h3 className="text-2xl font-semibold text-red-700 mb-2">The Problem</h3>
